    ...
    <div class="container relative mx-auto max-w-1166">
        ...
        <div class="relative -top-9">
            ...
            <div class="relative z-50 mx-auto space-y-36 max-w-929">
                <x-partenaire mode="even" title="Chateau de" subtitle="la Roque Forcade" image="{{ $page->baseUrl }}/assets/img/partenaires/chateaularoqueforcade.jpg" image_alt="Chateau de la Roque Forcade" link="https://www.chateaudelaroqueforcade.com/">
                ...
                <x-partenaire title="Chateau de" subtitle="Roquefeuille" image="{{ $page->baseUrl }}/assets/img/partenaires/chateauderoquefeuille.png" image_alt="Chateau de Roquefeuille" link="https://chateauderoquefeuille.fr/">
                ...
                <x-partenaire mode="even" title="Chateau" subtitle="Saint Hilaire" image="{{ $page->baseUrl }}/assets/img/partenaires/chateausainthilaire.png" image_alt="Chateau Saint Hilaire" link="https://www.chateau-saint-hilaire.fr/">
                ...
                <x-partenaire title="Inga" subtitle="des Riaux" image="{{ $page->baseUrl }}/assets/img/partenaires/ingadesriaux.jpg" image_alt="Inga des Riaux" link="http://www.ingadesriaux.com/">
                ...
                <x-partenaire mode="even" title="Chateau de" subtitle="la Beaumetane" image="{{ $page->baseUrl }}/assets/img/partenaires/chateaudelabeaumetane.jpg" image_alt="Chateau de la Beaumetane" link="https://www.chateau-la-beaumetane.fr/">
                ...
                <x-partenaire title="Le Moulin" subtitle="de Gemenos" image="{{ $page->baseUrl }}/assets/img/partenaires/lemoulindegemenos.jpg" image_alt="Le Moulin de Gemenos" link="http://www.moulin-gemenos.fr/">
                ...
                <x-partenaire mode="even" title="Le Mas de" subtitle="Garguiers" image="{{ $page->baseUrl }}/assets/img/partenaires/masdegarguiers.jpg" image_alt="Le Mas des Garguiers" link="http://www.mas-garguier.fr/">
        ...
        <div class="relative -top-9">
            <div class="z-10 w-3/5 grey-background h-93prct mb-50px top-20"></div>
            <div class="relative z-50 mx-auto space-y-36 max-w-929">
                <x-partenaire title="Palais des" subtitle="congrès Agora" image="{{ $page->baseUrl }}/assets/img/partenaires/agora.jpg" image_alt="Palais des congrès Agora" link="http://www.agora-congres.com/">
                ...
                <x-partenaire mode="even" title="Le" subtitle="BUZ" image="{{ $page->baseUrl }}/assets/img/partenaires/lebuz.jpg" image_alt="Le BUZ" link="https://www.buz-marseille.fr/">
                ...
                <x-partenaire title="Chateau de" subtitle="la Buzine" image="{{ $page->baseUrl }}/assets/img/partenaires/chateaudelabuzine.jpg" image_alt="Chateau de la Buzine" link="https://labuzine.com/">
